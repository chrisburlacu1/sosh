...
export const tipRegistry: ContextualTip[] = [
  ...
  {
    id: 'new-user-qwenmd',
    content: 'Add a SOSH.md file to give Sosh persistent project context.',
    trigger: 'startup',
  ...
  },
  {
    id: 'new-user-resume',
    content:
      'You can resume a previous conversation by running sosh --continue or sosh --resume.',
    trigger: 'startup',
    isRelevant: (ctx) => ctx.sessionCount < 10,
    cooldownPrompts: 0,
    priority: 70,
  ...
  {
    id: 'shell-commands',
    content: 'You can run any shell commands from Sosh using ! (e.g. !ls).',
    trigger: 'startup',
