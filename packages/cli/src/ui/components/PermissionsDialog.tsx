  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Sosh won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Sosh will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Sosh is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
